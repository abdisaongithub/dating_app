...
mixin _$NetworkExceptions {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String errorMessage) badRequest,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String errorMessage)? badRequest,
...
class _$UnauthorizedRequestImpl
  ...
  const _$UnauthorizedRequestImpl(this.errorMessage);
...
class _$BadRequestImpl with DiagnosticableTreeMixin implements BadRequest {
  const _$BadRequestImpl(this.errorMessage);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NetworkExceptions.badRequest(errorMessage: $errorMessage)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return badRequest?.call(errorMessage);
  }
...
abstract class BadRequest implements NetworkExceptions {
  const factory BadRequest(final String errorMessage) = _$BadRequestImpl;
...
class _$NotFoundImpl with DiagnosticableTreeMixin implements NotFound {
  const _$NotFoundImpl(this.errorMessage);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NetworkExceptions.notFound(errorMessage: $errorMessage)';
  }
...
class _$InternalServerErrorImpl
  ...
  const _$InternalServerErrorImpl(this.errorMessage);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NetworkExceptions.internalServerError(errorMessage: $errorMessage)';
  }
...
abstract class InternalServerError implements NetworkExceptions {
  const factory InternalServerError(final String errorMessage) =
